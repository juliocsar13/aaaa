@extends('frontend.layouts.frontend') 
    ...
    @section('og-facebook') 
        ...
        <meta property="og:title" content="{{ $oReview['name'] }}" />
                ...
                <div id="titlebar" class="listing-titlebar">
                    <div class="listing-titlebar-title">
                        ...
                        <div class="star-rating" data-rating="{{ $oReview['valoration'] }}">
                            <div class="rating-counter"><a href="#listing-reviews"> {{ $oReview['calification'] }} </a></div><!-- calificacion de una palabra que hare desde el back -->
                        </div>
                    </div>
                </div>
